...
function SendBox(props) {
  ...
  const renderEmoji = () => {
    return (
      <>
        <IconButton ref={emojiRef} className={classes.iconbtnStyle} onClick={(e) => handleClickEmoji(e, 0)}>
  ...
  const renderThridPartyEmoji = () => {
    return(
      <div className={classes.emojiBox}>
        <IconButton ref={emojiRef} className={classes.iconbtnStyle} onClick={(e) => handleClickEmoji(e, 3)}>
          <img alt="" className={classes.iconStyle} src={icon_emoji} />
        </IconButton>
        {
          <Popover
